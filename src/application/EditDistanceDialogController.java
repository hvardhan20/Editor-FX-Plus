...
public class EditDistanceDialogController {
	...
	private boolean includeDicFlag;
	...
	@FXML
	private CheckBox includeDicBox;
    
	
	@FXML
	private void initialize() {
		includeDicFlag=false;
        ...
        if(isInputValid()) {
    		...
    		Task<List<String>> task = new Task<List<String>>() {
    	        ...
    	        public List<String> call() {
    	    		...
    	    		List<String> path = wp.findPath(word1.getText(), word2.getText(),includeDicFlag);
                    return path;
    	        }
    		};
    ...
    @FXML
    private void handleIncDic() {
    	if(includeDicBox.isSelected())
    		includeDicFlag=true;
    	else
    		includeDicFlag=false;
